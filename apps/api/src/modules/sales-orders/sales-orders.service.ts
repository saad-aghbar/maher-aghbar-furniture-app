        ...
        const base = stripSalesOrderCosts(
          {
            ...
            lineStrip: row.lines.map((l) => ({
              id: l.id,
              nameEn: l.product?.nameEn ?? null,
              nameAr: l.product?.nameAr ?? null,
              nameHe: l.product?.nameHe ?? null,
              description: l.description ?? null,
              sku: l.product?.sku ?? null,
              quantity: Number(l.quantity),
              manufacturingComplexity: l.manufacturingComplexity ?? null,
