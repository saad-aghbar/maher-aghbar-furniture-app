export const queryKeys = {
  ...
  reports: {
    ...
    costMoney: (q: string) => [...queryKeys.reports.all, 'cost-money', q] as const,
    ...
    costProductProfile: (id: string, q: string) =>
      [...queryKeys.reports.all, 'cost-product', id, q] as const,
    costVariantProfile: (productId: string, variantId: string, q: string) =>
      [...queryKeys.reports.all, 'cost-variant', productId, variantId, q] as const,
    costCustomWork: (q: string) => [...queryKeys.reports.all, 'cost-custom', q] as const,
    ...
    costCoverage: (q = 'all') => [...queryKeys.reports.all, 'cost-coverage', q] as const,
    costCoverageIssues: (q: string) => [...queryKeys.reports.all, 'cost-coverage-issues', q] as const,
    costInventorySummary: () => [...queryKeys.reports.all, 'cost-inventory-summary'] as const,
    costInventoryFlow: (q: string) => [...queryKeys.reports.all, 'cost-inventory-flow', q] as const,
    costInventoryItems: (q: string) => [...queryKeys.reports.all, 'cost-inventory-items', q] as const,
    costInventoryItem: (id: string, q: string) =>
      [...queryKeys.reports.all, 'cost-inventory-item', id, q] as const,
