...
export const managementSummarySuccessFixture: ManagementSummaryPayload = {
  attention: [
    ...
    },
    {
      ...
      whyKey: 'returnWaiting',
      actionLabel: 'Open return',
      actionKey: 'openReturn',
      priority: 'normal',
    ...
    events: [
      {
        ...
        label: 'Upholstery started on SO-1258',
        href: '/sales-orders/so1',
        kind: 'taskStarted',
        params: { stage: 'Upholstery', stageEn: 'Upholstery', number: 'SO-1258' },
      },
      {
        at: '2026-08-05T09:40:00.000Z',
        label: 'QC passed SO-1260',
        href: '/sales-orders/so2',
        kind: 'qc',
        params: { number: 'SO-1260', result: 'PASSED' },
      },
    ],
  },
  blocked: [
  ...
  activity: [
    {
      at: '2026-08-05T09:30:00.000Z',
      label: 'SO-1258 status updated',
      href: '/sales-orders/so1',
      kind: 'statusUpdated',
      params: { number: 'SO-1258' },
    },
    {
      at: '2026-08-05T10:05:00.000Z',
      label: 'PO-441 received materials',
      href: '/purchasing',
      kind: 'materialsReceived',
      params: { number: 'PO-441' },
    },
    {
      at: '2026-08-05T11:20:00.000Z',
      label: 'Invoice INV-902 issued',
      href: '/invoices',
      kind: 'invoiceIssued',
      params: { number: 'INV-902' },
    },
  ],
  generatedAt: '2026-08-05T12:00:00.000Z',
};
