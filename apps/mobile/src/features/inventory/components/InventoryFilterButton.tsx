...
/**
 * Floor-style filter trigger — matches Orders Filter button.
 */
export function InventoryFilterButton({ onPress, activeCount = 0 }: Props) {
  ...
  return (
    <AnimatedPressable
      ...
      accessibilityLabel={t('mobile.inventory.filterTitle')}
