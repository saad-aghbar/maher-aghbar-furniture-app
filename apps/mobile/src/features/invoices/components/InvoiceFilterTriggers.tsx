...
/**
 * Two floor buttons under search: dealers (start) + status filter (end).
 */
    ...
    >
      {showDealers ? (
        <FloorTrigger
          ...
          a11yKey={
            dealerLabel
              ? 'accounting.dealerFilterShowing'
              : 'accounting.dealersTitle'
          }
    ...
    >
      ...
      {onClear ? (
        <AnimatedPressable
          variant="button"
          accessibilityRole="button"
          accessibilityLabel={t('accounting.allCustomers')}
          onPress={() => {
            void haptics.selection();
            onClear();
          }}
