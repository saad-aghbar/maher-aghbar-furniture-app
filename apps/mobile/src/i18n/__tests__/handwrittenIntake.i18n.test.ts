...
const KEYS = [
  ...
  'mobile.adminRequest.sheetHint',
  'mobile.adminRequest.sheetUnclearTitle',
  'mobile.adminRequest.sheetUnclearHint',
  'mobile.adminRequest.sheetUnclearMissing',
  'mobile.adminRequest.sheetUnclearUnclear',
  'mobile.adminRequest.sheetUnclearMismatch',
  'mobile.adminRequest.filledFromSheet',
