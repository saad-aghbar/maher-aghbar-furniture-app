...
const SCHEDULING_KEYS = [
  ...
  'mobile.adminScheduling.sync.action',
  'mobile.adminScheduling.sync.title',
  'mobile.adminScheduling.sync.confirmTitle',
  'mobile.adminScheduling.sync.confirmBody',
  'mobile.adminScheduling.sync.confirmCta',
  'mobile.adminScheduling.sync.syncing',
  'mobile.adminScheduling.sync.complete',
  'mobile.adminScheduling.sync.upToDate',
  'mobile.adminScheduling.sync.upToDateBody',
  'mobile.adminScheduling.sync.partial',
  'mobile.adminScheduling.sync.failed',
  'mobile.adminScheduling.sync.failedBody',
  'mobile.adminScheduling.sync.inProgress',
  'mobile.adminScheduling.sync.retry',
  'mobile.adminScheduling.sync.done',
  'mobile.adminScheduling.sync.viewAttention',
  'mobile.adminScheduling.sync.scanned',
  'mobile.adminScheduling.sync.alreadyValid',
  'mobile.adminScheduling.sync.replanned',
  'mobile.adminScheduling.sync.pastDueRescheduled',
  'mobile.adminScheduling.sync.generated',
  'mobile.adminScheduling.sync.atRiskRecovered',
  'mobile.adminScheduling.sync.stillAttention',
  'mobile.adminScheduling.sync.conflictsResolved',
  'mobile.adminScheduling.sync.newConflicts',
  'mobile.adminScheduling.sync.manualAttention',
  'mobile.adminScheduling.sync.blockedMaterials',
  'mobile.adminScheduling.sync.blockedWip',
  'mobile.adminScheduling.sync.blockedWorkers',
  'mobile.adminScheduling.sync.blockedEstimates',
  'mobile.adminScheduling.optimize.action',
  'mobile.adminScheduling.optimize.title',
  'mobile.adminScheduling.optimize.confirmTitle',
  'mobile.adminScheduling.optimize.confirmBody',
  'mobile.adminScheduling.optimize.confirmCta',
  'mobile.adminScheduling.optimize.previewing',
  'mobile.adminScheduling.optimize.previewTitle',
  'mobile.adminScheduling.optimize.previewBody',
  'mobile.adminScheduling.optimize.applyCta',
  'mobile.adminScheduling.optimize.applying',
  'mobile.adminScheduling.optimize.complete',
  'mobile.adminScheduling.optimize.upToDate',
  'mobile.adminScheduling.optimize.upToDateBody',
  'mobile.adminScheduling.optimize.partial',
  'mobile.adminScheduling.optimize.failed',
  'mobile.adminScheduling.optimize.failedBody',
  'mobile.adminScheduling.optimize.inProgress',
  'mobile.adminScheduling.optimize.retry',
  'mobile.adminScheduling.optimize.done',
  'mobile.adminScheduling.optimize.wouldMove',
  'mobile.adminScheduling.optimize.moved',
  'mobile.adminScheduling.optimize.pastDueRescheduled',
  'mobile.adminScheduling.optimize.emptyDay.noOrders',
  ...
  'mobile.adminScheduling.unscheduledTitle',
  'mobile.adminScheduling.unscheduledHint',
  ...
  'mobile.adminScheduling.sheets.overwriteApprovalTitle',
  'mobile.adminScheduling.sheets.overwriteApprovalBody',
  'mobile.adminScheduling.sheets.overwriteApprovalConfirm',
  'mobile.adminScheduling.sheets.overwriteApprovalSuccess',
  'mobile.adminScheduling.sheets.approvedLocked',
  'mobile.adminScheduling.sheets.inProductionLocked',
  'mobile.adminScheduling.sheets.assignLockedStarted',
  'mobile.adminScheduling.sheets.assignLockedNoStageTime',
  ...
  'mobile.newOrder.delivery.leadTimeNotice',
  'mobile.newOrder.delivery.earliestRequest',
  ...
  'mobile.orders.hubEyebrow',
  'mobile.orders.hubHint',
  'mobile.orders.searchDeliveries',
  'mobile.orders.emptyFilter',
  'mobile.orders.emptyFilterHint',
  'mobile.orders.address',
  'mobile.orders.qty',
  'mobile.orders.stubConfirmed',
  'mobile.orders.stubExpected',
  'mobile.orders.stubReview',
  'mobile.orders.stubDelayed',
  'mobile.orders.stubDelivered',
  'mobile.orders.viewAllDeliveries',
  'mobile.orders.viewAllDeliveriesZero',
  'mobile.orders.viewAllDeliveriesOne',
  'mobile.orders.viewAllDeliveriesTwo',
  'mobile.orders.viewAllDeliveriesFew',
  'mobile.orders.viewAllDeliveriesMany',
  'mobile.orders.showFewerDeliveries',
  ...
  'statuses.LATE',
  'mobile.adminScheduling.filters',
  'mobile.adminScheduling.stats.unscheduled',
  'mobile.adminScheduling.stats.overtime',
  'mobile.adminScheduling.factoryDay.title',
  'mobile.adminScheduling.factoryDay.load',
  'mobile.adminScheduling.stageDay.hours',
  'mobile.adminScheduling.timeline.title',
  'mobile.adminScheduling.workerDay.title',
  'mobile.adminScheduling.workerDay.day',
  'mobile.adminScheduling.workerDay.load',
  'mobile.adminScheduling.workerDay.empty',
  'mobile.adminScheduling.workerDay.week',
  'mobile.adminScheduling.workerDay.loading',
  'mobile.adminScheduling.workerDay.closed',
  'mobile.adminScheduling.workerDay.weekError',
  'mobile.adminScheduling.workerDay.openDay',
  'mobile.adminScheduling.overtimeBadge',
  'mobile.adminScheduling.unscheduledDemand.title',
  'mobile.adminScheduling.orderCard.details',
  'mobile.adminScheduling.scheduleOrder.title',
  'mobile.adminScheduling.scheduleOrder.action',
  'mobile.adminScheduling.planningState.NEEDS_PLANNING',
  'mobile.adminScheduling.planningState.READY_TO_SCHEDULE',
  'mobile.adminScheduling.unscheduled.needsPlanningHint',
  'mobile.adminScheduling.filter.dealer',
  'mobile.adminScheduling.filter.readinessReady',
  'mobile.adminScheduling.filter.searchDealers',
  'mobile.adminScheduling.filter.noDealersMatch',
  'mobile.adminScheduling.taskSheet.freeWindows',
  'mobile.adminScheduling.taskSheet.history',
  'mobile.adminScheduling.taskSheet.reason',
  'mobile.adminScheduling.dayCapacity.workers',
  'mobile.adminScheduling.dayCapacity.allWorkers',
  'mobile.adminScheduling.dayCapacity.searchWorkers',
  'mobile.adminScheduling.dayCapacity.noWorkersMatch',
  'mobile.adminScheduling.dayCapacity.selectedCount',
  'mobile.adminScheduling.dayCapacity.impact',
  'mobile.adminScheduling.focusFilter.unscheduled',
  'mobile.adminScheduling.focusFilter.overtime',
] as const;
