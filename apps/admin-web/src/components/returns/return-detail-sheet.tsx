      ...
      >
        <div className="space-y-5">
          ...
          <div className="space-y-2 border-t border-border pt-4">
            ...
            {invoice ? (
              <Link href={`/invoices/${invoice.id}`} className="text-sm font-medium text-brand hover:underline">
          ...
          <div className="space-y-2 border-t border-border pt-4">
            ...
            {(detail.reshipDeliveries ?? []).map((delivery) => (
              <p key={delivery.id} className="text-xs text-text-secondary">
                <Link href={`/deliveries/${delivery.id}`} className="text-brand hover:underline">
  ...
  return (
    <div className="rounded-lg border border-border bg-[var(--maher-surface-muted)]/40 p-3 space-y-2">
      ...
      {piece.productionOrder ? (
        <Link
          href={`/production/${piece.productionOrder.id}`}
      ...
      {piece.recoveryOrder ? (
        <Link
          href={`/production/${piece.recoveryOrder.id}`}
          className="text-xs text-brand hover:underline"
        >
