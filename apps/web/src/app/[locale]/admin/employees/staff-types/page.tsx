              ...
              <Card
                ...
                footer={
                  <div className="flex flex-wrap gap-1">
                    <Button size="sm" variant="secondary" onClick={() => router.push(`/admin/employees/staff-types/${row.id}`)}>
                      {t('view')}
                    </Button>
                    <Button size="sm" variant="ghost" onClick={() => router.push(`/admin/employees/staff-types/${row.id}`)}>
                      {tCommon('edit')}
                    </Button>
                    <Button
                      size="sm"
