  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 border-t border-[var(--maher-border)] bg-[var(--maher-surface)]/95 p-2.5">
          <Ltr className="text-[10px] font-semibold text-[var(--maher-text-tertiary)]">
            {order.number}
          </Ltr>
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 pb-4">
      <section className="relative overflow-hidden rounded-[20px] border border-[var(--maher-border-strong)] bg-[var(--maher-surface)] text-[var(--maher-text-primary)] shadow-[var(--maher-shadow-sm)]">
        <span
          aria-hidden
        ...
        <div className="relative flex flex-col gap-6 p-6 ps-7 sm:p-8 sm:ps-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl space-y-3">
            ...
            <p className="max-w-xl text-sm leading-relaxed text-[var(--maher-text-secondary)] sm:text-base">
      ...
      <section className="space-y-3">
        ...
        <div className="maher-stagger relative flex gap-2 overflow-x-auto overflow-y-visible py-1 sm:gap-3 sm:overflow-visible">
          ...
          />
          <PipelineStep
            href="/admin/sales-orders?status=COMPLETED"
...
function WarehouseStaffDashboard({
  ...
  return (
    <div className="space-y-8 pb-4">
      <section className="relative overflow-hidden rounded-[20px] border border-[var(--maher-border-strong)] bg-[var(--maher-surface)] p-6 ps-7 shadow-[var(--maher-shadow-sm)] sm:p-8 sm:ps-8">
        <span
          aria-hidden
          className="pointer-events-none absolute inset-y-0 start-0 w-[3px] bg-[var(--maher-brand)] opacity-55"
        />
        <h1 className="text-3xl font-semibold tracking-tight text-[var(--maher-text-primary)]">
          {firstName
            ? tCommon('dashboardGreetingNamed', { name: firstName })
            : tCommon('dashboardGreeting')}
        </h1>
        <p className="mt-2 max-w-xl text-sm text-[var(--maher-text-secondary)]">
