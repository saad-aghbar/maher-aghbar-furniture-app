...
export const REPORTS_SECTIONS = [
  { href: '/admin/reports', key: 'sectionMoney' },
  { href: '/admin/reports/orders', key: 'lensOrders' },
  { href: '/admin/reports/products', key: 'sectionProducts' },
  { href: '/admin/reports/products/custom', key: 'sectionCustom' },
  { href: '/admin/reports/inventory', key: 'sectionInventory' },
  { href: '/admin/reports/returns', key: 'lensReturns' },
  { href: '/admin/reports/coverage', key: 'coverage' },
] as const;
