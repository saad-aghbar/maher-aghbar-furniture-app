...
const navItems = [
  { href: '/worker/dashboard', key: 'home', icon: Home },
  { href: '/worker/tasks', key: 'myOrders', icon: ClipboardList },
  { href: '/worker/tasks/completed', key: 'completeTask', icon: CheckCircle2 },
] as const;
