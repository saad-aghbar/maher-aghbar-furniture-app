/**
 * Stable basket-line letters under a sales order: A…Z then AA, AB…
 * Display / factory id is `{salesOrder.number}.{letter}` (e.g. SO-2026-00026.A).
 * Quantity on a line does not consume extra letters.
 */
