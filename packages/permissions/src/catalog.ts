...
const p = {
  ...
  returnInspect: 'return.inspect',
  returnWork: 'return.work',
  returnScrapApprove: 'return.scrap.approve',
  returnReplacementCreate: 'return.replacement.create',
  returnRecoveryPost: 'return.recovery.post',
