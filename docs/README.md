...
- Universal app (phone / tablet / iPad / Mac): [UNIVERSAL_APP_COMPLETE_IMPLEMENTATION.md](UNIVERSAL_APP_COMPLETE_IMPLEMENTATION.md) · [UNIVERSAL_APP_FINAL_UAT.md](UNIVERSAL_APP_FINAL_UAT.md) · [WINDOWS_SPIKE.md](WINDOWS_SPIKE.md)
- Apple Watch companion (native watchOS, Phases 0–2): [APPLE_WATCH_ARCHITECTURE.md](APPLE_WATCH_ARCHITECTURE.md) · [APPLE_WATCH_ARCHITECTURE_AUDIT.md](APPLE_WATCH_ARCHITECTURE_AUDIT.md) · [APPLE_WATCH_IMPLEMENTATION.md](APPLE_WATCH_IMPLEMENTATION.md) · [APPLE_WATCH_UAT.md](APPLE_WATCH_UAT.md)
...
- Notifications: [NOTIFICATIONS.md](NOTIFICATIONS.md) · [NOTIFICATIONS_SLICE_5.md](NOTIFICATIONS_SLICE_5.md) · [NOTIFICATIONS_SLICE_6.md](NOTIFICATIONS_SLICE_6.md) · [NOTIFICATIONS_SLICE_7.md](NOTIFICATIONS_SLICE_7.md) · [NOTIFICATIONS_PHYSICAL_PUSH_UAT.md](NOTIFICATIONS_PHYSICAL_PUSH_UAT.md)
...
- Inventory: [inventory-rearchitecture-audit.md](inventory-rearchitecture-audit.md) · [inventory-rearchitecture-changes.md](inventory-rearchitecture-changes.md) · [inventory-migration-report.md](inventory-migration-report.md) · [inventory-production-gap-audit.md](inventory-production-gap-audit.md) · [inventory-production-gap-closure.md](inventory-production-gap-closure.md) · [raw-material-qr-warehouse-audit.md](raw-material-qr-warehouse-audit.md) · [inventory-qr-identity-closure-report.md](inventory-qr-identity-closure-report.md) · [inventory-item-report-pdf-closure-report.md](inventory-item-report-pdf-closure-report.md)
